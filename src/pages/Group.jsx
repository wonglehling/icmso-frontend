...
export default function Group() {
  ...
  useEffect(() => {
    const newRows = []
    data && data.group_members.forEach(member => {
      newRows.push(
        createData(member.group_member_id.user_first_name + " " + member.group_member_id.user_last_name,
          formatDate(member.group_member_join_date),
          member.group_member_type,
          member.group_member_research_interests.map(interest => interest + ","),
          "Edit Delete",
